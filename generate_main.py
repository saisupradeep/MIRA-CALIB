...
with open(os.path.join(BASE_DIR, "bundled_index.html"), "r", encoding="utf-8") as f:
    bundled_html = f.read()

main_py_template = f'''import asyncio
import json
import os
...
# Self-contained bundled HTML UI
...
async def serve_index():
    return HTMLResponse(content=BUNDLED_HTML)
...
print("Self-contained main.py generated successfully!")
